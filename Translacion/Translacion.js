function Formula_1(ro_x_1, ro_y_1, v_x_1, v_y_1, t_1){
    ...
    document.getElementById('Formula_1').innerHTML = "r("+t_1+") = ("+ro_x_1+", "+ro_y_1+") + ("+v_x_1+", "+v_y_1+")"+t_1+" El resultado es: ("+rt_x+", "+rt_y+").";
}
...
function Formula_2(rt_x_1, rt_y_1, v_x_1, v_y_1, t_1){
    ...
    document.getElementById('Formula_2').innerHTML = "ro = ("+rt_x_1+", "+rt_y_1+") - ("+v_x_1+", "+v_y_1+")"+t_1+" El resultado es: ("+rt_x+", "+rt_y+").";
}